...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
  ...
  <xsl:template match="cda:id | cda:setId">
    ...
    <xsl:choose>
      ...
      <xsl:when test="@root and @extension and string-length($pAssigningAuthorityName) > 0">
        <xsl:element name="{$pElementName}">
          <system value="{lower-case($root-uri)}" />
          <value value="{$value}" />
          <assigner>
      ...
      <xsl:when test="@root and not(@extension) and string-length($pAssigningAuthorityName) > 0">
        <xsl:element name="{$pElementName}">
  ...
  -->
  <xsl:template
    match="cda:code | cda:confidentialityCode | cda:maritalStatusCode | cda:routeCode | cda:raceCode | sdtc:raceCode | cda:ethnicGroupCode | cda:religiousAffiliationCode | cda:targetSiteCode | cda:priorityCode | cda:translation | cda:methodCode | cda:approachSiteCode | sdtc:functionCode | cda:functionCode | cda:dischargeDispositionCode | sdtc:dischargeDispositionCode | cda:softwareName">
