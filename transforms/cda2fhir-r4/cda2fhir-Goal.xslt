...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
    ...
    <xsl:template match="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.121']]" mode="bundle-entry">
        <xsl:choose>
    ...
    <xsl:template match="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.121']]">
        <Goal>
            ...
            <xsl:call-template name="author-reference">
                <xsl:with-param name="pElementName">expressedBy</xsl:with-param>
            </xsl:call-template>
