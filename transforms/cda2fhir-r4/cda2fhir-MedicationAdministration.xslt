...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
  ...
  <xsl:template
    ...
    <MedicationAdministration>
      ...
      <xsl:for-each
        select="cda:entryRelationship/cda:*[not(cda:templateId/@root = '2.16.840.1.113883.10.20.15.2.3.37') and not(cda:templateId/@root = '2.16.840.1.113883.10.20.22.4.19') and not(cda:templateId/@root = '2.16.840.1.113883.10.20.22.4.118')]">
