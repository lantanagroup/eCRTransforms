...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
  ...
  <xsl:template match="cda:observation" mode="bundle-entry">
    ...
    <xsl:for-each select="cda:author[cda:*[cda:*[not(@nullFlavor)]]] | cda:informant[cda:*[cda:*[not(@nullFlavor)]]]">
  ...
  <xsl:template match="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.2' or @root = '2.16.840.1.113883.10.20.22.4.27']][not(cda:code[@code = '8480-6' or @code = '8462-4'])]">
    ...
    <Observation>
      ...
      <xsl:for-each
        select="cda:entryRelationship/cda:act[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.64']]/cda:text | cda:entryRelationship/cda:act[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.202']]/cda:text | cda:text">
  ...
  <xsl:template match="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.27']][cda:code[@code = '8480-6']]">
    <Observation>
      ...
      <xsl:for-each select="cda:code[@code = '8480-6'] | parent::cda:component/following-sibling::cda:*[1]/cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.27']]/cda:code[@code = '8462-4']">
        <component>
