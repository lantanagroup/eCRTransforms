...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
  ...
  <xsl:template name="create-organization">
    ...
    <Organization>
      ...
      <!-- SG: Update to deal with nullFlavor -->
      <xsl:choose>
        <xsl:when test="cda:name/text()">
          <name>
        ...
        <xsl:when test="cda:name[@nullFlavor]">
          <name>
            <xsl:apply-templates select="cda:name/@nullFlavor" mode="data-absent-reason-extension" />
          </name>
        </xsl:when>
        <xsl:otherwise>
