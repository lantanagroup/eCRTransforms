...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
    ...
    <entry>
      ...
      <resource>
        <Provenance>
          ...
          <!-- 20260423 SG: Added for Data Augmentation (author.functionCode)  -->
          <!-- activity -->
          <xsl:apply-templates select="cda:functionCode">
            <xsl:with-param name="pElementName">activity</xsl:with-param>
          </xsl:apply-templates>
          <!-- agent -->
          <agent>
            <!-- type -->
  ...
  <xsl:template match="cda:relatedDocument[@typeCode = 'XFRM']" mode="provenance">
    <entry>
      <fullUrl value="urn:uuid:{cda:parentDocument/@lcg:uuid}" />
      <resource>
        <!-- fill some variables that we may need to use in two places -->
        <Provenance>
          <!-- target -->
