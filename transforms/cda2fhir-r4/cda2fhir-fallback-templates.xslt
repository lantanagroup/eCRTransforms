...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir"
  ...
  <xsl:template
    match="*[parent::cda:entry] | *[parent::cda:entryRelationship] | *[parent::act[cda:templateId[@root = '2.16.840.1.113883.10.20.22.4.132'][@extension = '2015-08-01']]]"
    priority="-10" mode="bundle-entry">
    <xsl:choose>
