...
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:lcg="http://www.lantanagroup.com" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc"
  xmlns:uuid="http://www.uuid.org" xmlns:xhtml="http://www.w3.org/1999/xhtml" version="2.0" exclude-result-prefixes="lcg xsl cda fhir xhtml">
  ...
  <xsl:template match="fhir:Composition">
    ...
    <ClinicalDocument>
      ...
      <xsl:apply-templates select="fhir:extension[@url = $vCompositionOrderExtension]" mode="inFulfillmentOf"> </xsl:apply-templates>
  ...
  <xsl:template match="fhir:QuestionnaireResponse">
          ...
          <structuredBody>
            ...
            <xsl:for-each select="$questionnaire-mapping/fhir:map[@type = ('section')][@linkId=($vQuestionnaireResponse//fhir:linkId/@value)]">
              ...
              <!-- Create the sections and their entries -->
                <xsl:apply-templates select="$vQuestionnaireResponse//fhir:item[fhir:linkId/@value = $vLinkId]" mode="section">
    ...
    <xsl:apply-templates select="$vFHIR2CDAResult" mode="gen-hai-narrative" />
            ...
            <xsl:when test="fhir:type/@value = 'individual'">
              ...
              <component>
                <section>
                  ...
                  <templateId root="2.16.840.1.113883.10.20.24.2.1" extension="2019-12-01" />
                  <!-- Patient Data Section QDM (V7) - CMS -->
                  <templateId root="2.16.840.1.113883.10.20.24.2.1.1" extension="2020-02-01" />
      ...
      <observation classCode="OBS" moodCode="EVN">
        ...
        <entryRelationship typeCode="SUBJ" inversionInd="true">
          <observation classCode="OBS" moodCode="EVN">
            ...
            <value xsi:type="INT" value="{fhir:count/@value}" />
  ...
  <xsl:template match="fhir:subjectResults">
    ...
    <xsl:if test="fhir:reference">
      ...
      <xsl:apply-templates select="ancestor::fhir:entry[1]/fhir:resource/fhir:*/fhir:contained/fhir:*[fhir:id/@value = $id]" mode="subject-list" />
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template match="fhir:List" mode="subject-list">
    <xsl:for-each select="fhir:entry/fhir:item">
      ...
      <xsl:apply-templates select="//fhir:entry[fhir:fullUrl/@value = $fullUrl]/fhir:resource/fhir:*" mode="external-document" />
    </xsl:for-each>
  </xsl:template>
