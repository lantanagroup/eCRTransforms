...
-->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:lcg="http://www.lantanagroup.com" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" exclude-result-prefixes="lcg xsl cda fhir" version="2.0">
  ...
  <xsl:template match="fhir:MedicationAdministration" mode="entryAdmissionMedication">
    <xsl:param name="generated-narrative">additional</xsl:param>
    <!-- MD: call make-medication-administration instead of make-admission-medication 
    <xsl:if test="$generated-narrative = 'generated'">
      <xsl:attribute name="typeCode">DRIV</xsl:attribute>
    </xsl:if>
    <entry>   
  ...
  <xsl:template name="make-admission-medication">
    ...
    <substanceAdministration classCode="SBADM" moodCode="EVN">
      ...
      <xsl:apply-templates select="fhir:extension[@url = 'http://hl7.org/fhir/us/ecr/StructureDefinition/therapeutic-medication-response-extension']" mode="entryRelationship" />
      <xsl:apply-templates select="fhir:extension[@url = 'http://hl7.org/fhir/us/ecr/StructureDefinition/us-ph-therapeutic-medication-response-extension']" mode="entryRelationship" />
