  ...
  <xsl:template match="fhir:extension" mode="inFulfillmentOf">
    ...
    <xsl:choose>
      <xsl:when test="fhir:valueReference/fhir:reference">
        <xsl:variable name="vEntryFullUrl" 
          select="//fhir:entry[fhir:resource/fhir:Composition/fhir:extension/@url=$vCompositionOrderExtension]/
          fhir:fullUrl/@value"/>
        ...
        <xsl:apply-templates select="//fhir:entry[fhir:fullUrl/@value = $referenceURI]/
